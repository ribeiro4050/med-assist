<!-- como funcionan esse trecho de roteament
 
eu preciso colar um desse em todos os arquivs ou só nesse 

preciso concertar os caminhos qu eestão aqui-->

<?php
// Define o ponto de entrada da página
$page = $_GET['page'] ?? null;

// Conteúdo que será renderizado no meio do HTML principal
$content_file = '';

switch ($page) {
    case null:
    case 'home':
        // Se não houver ?page= ou se for ?page=home, carrega a landing page
        $content_file = 'view/landing_page.php';
        break;

    case 'login_form':
        // A rota que o botão "Entrar" deve chamar
        $content_file = 'login_form.php'; 
        break;
        
    case 'cadastro_paciente':
        // A rota que o botão "Cadastrar" deve chamar
        // Vou assumir que essa view ainda será criada
        $content_file = 'view/cadastro_paciente_form.php';
        break;

    // Adicione outras rotas (como `login_action`, `lista`, `historico`) aqui:
    // case 'lista': 
    //     $content_file = 'controller/lista-pacientes-controller.php'; 
    //     break;
        
    default:
        // Caso a rota não exista (404)
        http_response_code(404);
        $content_file = 'view/404.php';
        break;
}
?>
...
<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-sm">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="d-flex">
        <a href="index.php?page=login.php" class="btn btn-outline-primary me-2">Entrar</a>
